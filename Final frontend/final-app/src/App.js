...
class Cafe3menu extends React.Component {
  render() {
    return (
      <div className="clark"><p> Menu items today:</p></div>
    );
  }
}
...
class Cafe3Average extends React.Component {
  render() {
    return (
      <div className="clark"><p> Average rating:</p></div>
    );
  }
}
...
class Cafe3Title extends React.Component {
  render() {
    return (
      <div className="title"><p>Cafe 3</p></div>
    )
  }
}
...
class CroadsTitle extends React.Component {
  render() {
    return (
      <div className="title"><p>Crossroads</p></div>
    )
  }
}
...
class FoothillTitle extends React.Component {
  render() {
    return (
      <div className="title"><p>Foothill</p></div>
    )
  }
}
...
class ClarkTitle extends React.Component {
  render() {
    return (
      <div className="title"><p>Clark Kerr</p></div>
    )
  }
}
